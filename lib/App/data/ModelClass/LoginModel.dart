...
//
//     final logingModel = logingModelFromJson(jsonString);

import 'dart:convert';

import 'package:myamco/App/data/ModelClass/error_response.dart';

LogingModel logingModelFromJson(String str) => LogingModel.fromJson(json.decode(str));

String logingModelToJson(LogingModel data) => json.encode(data.toJson());
...
class LogingModel {
  ...
  factory LogingModel.fromJson(Map<String, dynamic> json) => LogingModel(
